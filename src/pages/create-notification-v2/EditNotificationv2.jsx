          ...
          <form onSubmit={handleSubmit} className="form-field-wrapper">
              ...
              <div className="col-12 col-lg-12">
                ...
                {form?.userType === "web" && (
                  <div className="col-12 col-lg-12 mt-4 mb-4">
                    ...
                    >
                      <label className="col-1 form-check-label font">
                        Reject Reason
                      </label>
                      <textarea
                        placeholder="Comment is mandatory for rejection/expiring notification."
                        name="notificationText"
                        className="form-control formcontrol"
                        rows={1}
                        value={form.notificationText}
            ...
            {user.role === 1 && (
              <div className="btn-section text-lg-center d-lg-flex gap-3 justify-content-end">
                ...
                {form?.userType === "web" ? (
                  <>
                    <button type="button" className="btn red-btn w-150p">
                      Expire
                    </button>
                    ...
                    <button type="submit" className="btn approve-btn w-150p">
                      Approve
                    </button>
                  </>
                ) : (
                  <>
                    ...
                    <button type="button" className="btn sky-blue-btn w-150p">
                      Save Draft
                    </button>
...
export default EditNotificationv2;
