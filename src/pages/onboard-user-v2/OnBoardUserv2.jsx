                  ...
                  <div className="row w-100">
                    ...
                    <label className="radio-label col-5">
                      <input
                        ...
                        value="3"
                      />
                      <span className="font">Test Card Request View User</span>
                    </label>
                  </div>
            ...
            <AccordionItem>
              ...
              <AccordionItemPanel>
                <div className="d-flex gap-4 flex-column w-80 m-auto">
                  ...
                  <div className="row">
                    <div className="col-6 row align-items-center onboarduserv2-form">
                      <label className="font">Test Card Shipping Address</label>
                    </div>
                    <div
